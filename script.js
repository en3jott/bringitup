...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var showUpSlider = new _modules_slider_slider_mini_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_slider_mini_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_slider_mini_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return VideoPayer; });
...
/*#__PURE__*/
function () {
  function VideoPayer(triggers, overlay) {
    _classCallCheck(this, VideoPayer);
  ...
  _createClass(VideoPayer, [{
    ...
    key: "createPalyer",
    value: function createPalyer(url) {
